...
gotchi_sales['Eyes Item'] = gotchi_sales['Eyes'].apply(lambda x: '' if x == 0 else wearables_data[str(x)]["0"])
gotchi_sales['Head Item'] = gotchi_sales['Head'].apply(lambda x: '' if x == 0 else wearables_data[str(x)]["0"])
gotchi_sales['Left Hand Item'] = gotchi_sales['Left Hand'].apply(lambda x: '' if x == 0 else wearables_data[str(x)]["0"])
gotchi_sales['Right Hand Item'] = gotchi_sales['Right Hand'].apply(lambda x: '' if x == 0 else wearables_data[str(x)]["0"])
gotchi_sales['Pet Item'] = gotchi_sales['Pet'].apply(lambda x: '' if x == 0 else wearables_data[str(x)]["0"])
gotchi_sales['Background Item'] = gotchi_sales['Background'].apply(lambda x: '' if x == 0 else wearables_data[str(x)]["0"])

gotchi_sales.to_csv(DATA_PATH.joinpath('gotchi_sales.csv'))
